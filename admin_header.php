		...
		<div class="container">
			...
			<?php 
			   ...
			   '<li><a href="admin_index.php">Home</a></li>
				...
				<li><a href="admin_research.php">Research</a></li>
				<li><a href="admin_group.php">Group</a></li>
				<li><a href="admin_publication.php">Publications</a></li>
				<li><a href="admin_resources.php">Resources</a></li>
